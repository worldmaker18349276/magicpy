...
tetrahedron = Intersection(*[Halfspace(v, -ri_tetra/ru_tetra, True) for v in vertices_tetra])
octahedron = Intersection(*[Halfspace(v, -ri_octa/ru_octa, True) for v in vertices_cube])
cube = Intersection(*[Halfspace(v, -ri_cube/ru_cube, True) for v in vertices_octa])
icosahedron = Intersection(*[Halfspace(v, -ri_icosa/ru_icosa, True) for v in vertices_dodeca])
dodecahedron = Intersection(*[Halfspace(v, -ri_dodeca/ru_dodeca, True) for v in vertices_icosa])
